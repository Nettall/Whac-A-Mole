...
import com.example.whac_a_mole.data.Data
...
class FragmentGame : Fragment() {
    ...
    private val holeList by lazy {
        listOf(
            Data(holes[0], R.drawable.mole_anim_0, R.drawable.mole_animation),
            Data(holes[1], R.drawable.mole_anim_0, R.drawable.mole_animation),
            Data(holes[2], R.drawable.mole_anim_0, R.drawable.mole_animation),
            Data(holes[3], R.drawable.mole_anim_0, R.drawable.mole_animation),
            Data(holes[4], R.drawable.mole_anim_0, R.drawable.mole_animation),
            Data(holes[5], R.drawable.mole_anim_0, R.drawable.mole_animation),
            Data(holes[6], R.drawable.mole_anim_0, R.drawable.mole_animation),
            Data(holes[7], R.drawable.mole_anim_0, R.drawable.mole_animation),
            Data(holes[8], R.drawable.mole_anim_0, R.drawable.mole_animation)
        )
    }

    private val gameTimer by lazy {
        object : CountDownTimer(30_000L, Data.DEFAULT_TIME) {
